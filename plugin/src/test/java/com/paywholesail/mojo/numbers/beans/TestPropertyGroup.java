...
public class TestPropertyGroup
{
    ...
    public void testConstant()
    {
        ...
        final PropertyGroup pg = new PropertyGroup("hello", true, true, IWFEnum.FAIL, IWFEnum.FAIL, props);
    ...
    public void testRenderEmptyOk()
    {
        ...
        final PropertyGroup pg = new PropertyGroup("hello", true, true, IWFEnum.FAIL, IWFEnum.IGNORE, props);

 ...
 */
package com.paywholesail.mojo.numbers.macros;
...
import com.paywholesail.mojo.numbers.AbstractNumbersMojo;
import com.paywholesail.mojo.numbers.ValueProvider;
import com.paywholesail.mojo.numbers.beans.IWFCEnum;
...
{
    private static final Logger LOG = LoggerFactory.getLogger(ScmMacro.class);
    ...
    public void setScmManager(final ScmManager scmManager)
    {
    ...
    public String getConnectionUrl(final Scm scm, final Properties props)
    {
        ...
        if (StringUtils.isNotBlank(scm.getConnection()) && !requireDeveloperConnection) {
            final String url = Objects.toString(scm.getConnection(), scm.getDeveloperConnection());

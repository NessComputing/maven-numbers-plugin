...
public class PropertyGroup
{
    ...
    {
        String propertyValue = MoreObjects.firstNonNull(properties.getProperty(propertyName), "");

        for (final Map.Entry<String, String> entry : propElements.entrySet()) {
        ...
        IWFEnum.checkState(getOnMissingProperty(), Objects.equals(propertyValue, result), "property");
        return result;
    }
}
